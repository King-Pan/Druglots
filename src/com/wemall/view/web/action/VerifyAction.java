...
public class VerifyAction {
    ...
    public void validate_code(HttpServletRequest request, HttpServletResponse response, String code, String code_name){
        ...
        if (CommUtil.null2String(code_name).equals("")){
            verify_code = (String)session.getAttribute("code");
    ...
    @RequestMapping({"/verify_user.htm"})
    public void verify_user(HttpServletRequest request, HttpServletResponse response, String userName, String id){
        boolean ret = false;
        Map params = new HashMap();
        params.put("userName", userName);
        params.put("id", CommUtil.null2Long(id));
    ...
    public void verify_code(HttpServletRequest request, HttpServletResponse response, String code){
        HttpSession session = request.getSession(false);
        String verify_code = "";
        if (CommUtil.null2String(code).equals(""))
    ...
    @RequestMapping({"/verify_phone.htm"})
    public void verify_phone(HttpServletRequest request, HttpServletResponse response, String phone, String id){
        boolean ret = true;
      System.out.println(phone);
        HttpClass hc = new HttpClass();
        String fanhui = null;
		try {
			fanhui = hc.load("http://127.0.0.1:8081/ssm_project/invitationchaphone", "phone="+phone);
		} catch (Exception e1) {
