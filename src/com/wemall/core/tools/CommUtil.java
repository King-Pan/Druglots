...
public class CommUtil {
    ...
    public static void saveIPageList6ModelAndView(String url, String staticURL, String params, IPageList pList, ModelAndView mv){
        if (pList != null){
            mv.addObject("objsix", pList.getResult());
            mv.addObject("totalPage", new Integer(pList.getPages()));
            mv.addObject("pageSize", Integer.valueOf(pList.getPageSize()));
            mv.addObject("rows", new Integer(pList.getRowCount()));
            mv.addObject("currentPage", new Integer(pList.getCurrentPage()));
    ...
    public static void saveIPageList3ModelAndView(String url, String staticURL, String params, IPageList pList,IPageList pList1, ModelAndView mv){
        if (pList != null){
            mv.addObject("objs", pList.getResult());
            mv.addObject("totalPage", new Integer(pList.getPages()));
            mv.addObject("pageSize", Integer.valueOf(pList.getPageSize()));
        ...
        if (pList1 != null){
            mv.addObject("obj", pList1.getResult());
            mv.addObject("totalPage", new Integer(pList1.getPages()));
            mv.addObject("pageSize", Integer.valueOf(pList1.getPageSize()));
            mv.addObject("rows", new Integer(pList1.getRowCount()));
            mv.addObject("currentPage", new Integer(pList1.getCurrentPage()));
            mv.addObject("gotoPageHTML", showPageHtml(url, params, pList1.getCurrentPage(), pList1.getPages()));
            mv.addObject("gotoPageFormHTML", showPageFormHtml(pList1.getCurrentPage(), pList1.getPages()));
            mv.addObject("gotoPageStaticHTML", showPageStaticHtml(staticURL, pList1.getCurrentPage(), pList1.getPages()));
            mv.addObject("gotoPageAjaxHTML", showPageAjaxHtml(url, params, pList1.getCurrentPage(), pList1.getPages()));
        }
    }
