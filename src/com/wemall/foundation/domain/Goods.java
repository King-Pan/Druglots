...
public class Goods extends IdEntity {
	/*
	 * 选填字段
	 *`orientation_symptom` varchar(255) DEFAULT NULL COMMENT '适应症状',
	  `usage_dosage` varchar(255) DEFAULT NULL COMMENT '用法与用量',
	  `untoward_effect` varchar(255) DEFAULT NULL COMMENT '不良反应',
	  `gross_weight` decimal(12,0) DEFAULT NULL COMMENT '商品毛重',
	  `unique_identification` varchar(255) DEFAULT NULL COMMENT '唯一标识',
	 */
	
	private String orientation_symptom;
    ...
    public String getOrientation_symptom() {
		return orientation_symptom;
	}

	public void setOrientation_symptom(String orientation_symptom) {
		this.orientation_symptom = orientation_symptom;
	}
